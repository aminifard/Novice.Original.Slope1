...
%
% Scales mu, A and b so that the largest eigenvalue of A'*M*A is 1 
% and the new problem
%
%       min ||x||_1 + mu/2 * ||Ax - b||_M^2
%
% is equivalent to the old one.  We assume that A and M are both
% functions that take the arguments (x,mode), and return, for instance,
% A*x if mode == 1 and A'*x if mode == 2.
